...
df = df.dropna(subset=['Date'])
    ...
    # =========================================================
    st.title("📦 Intelligent Demand & Inventory Management System")
    ...
    # =========================================================
    tab1, tab2, tab3 = st.tabs(["📈 Forecasting", "📦 Inventory Health", "🚨 Reorder Actions"])
    ...
    with tab3:
        ...
        if 'Suggested_Order' in df_filtered.columns:
            ...
            st.download_button(
                label="⬇️ Download Order List as CSV",
                data=csv,
    ...
    # --------------------------------------------------
    st.info("👈 Please upload the `final_dashboard_data.csv` file from the sidebar to start.")
    st.markdown("""
